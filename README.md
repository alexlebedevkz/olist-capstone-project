...
Презентация для защиты: [`reports/presentation.pdf`](reports/presentation.pdf).
...
├── reports/
│   ├── presentation.pdf      # презентация для защиты (8 слайдов)
│   └── figures/              # 15 графиков для отчёта и презентации
...
2. Установить зависимости:
   ...
   ```
3. Собрать базу (~30 секунд, около 220 МБ):
   ```
